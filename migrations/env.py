...
# Model metadata ni import qilish
from models.base import Base  # models.py dan Base ni import qilamiz

target_metadata = Base.metadata  # User modeli uchun metadata
